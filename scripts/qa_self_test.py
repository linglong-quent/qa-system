...
def main():  # noqa: STYLE-06
    ...
    _test_yaml_and_contracts(base, scripts_dir)
...
def _test_yaml_and_contracts(base: str, scripts_dir: str):
    ...
    _test_schema_and_config(base, scripts_dir)

def _test_schema_and_config(base: str, scripts_dir: str):
    """Sections 5-6: Schema + Config consistency"""
    # =============================================
